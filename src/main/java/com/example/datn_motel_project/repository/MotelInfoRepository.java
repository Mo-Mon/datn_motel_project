...
public interface MotelInfoRepository {
    ...
    Integer getTotalMotelAdmin(String title, String location, String project, String nameUserPort);

    List<Motel> getListMotelAdmin(String title, String location, String project, String nameUserPort, Integer offset, Integer maxResults);
